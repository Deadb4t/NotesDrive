...
string UtilsAuthentication::MakeDateTimeStamp()
{
    boost::posix_time::ptime now = boost::posix_time::second_clock::universal_time();
    return to_iso_string(now);
}
bool UtilsAuthentication::ValidTimeStamp(string timeStampStr)
{
    boost::posix_time::ptime timeStamp(boost::posix_time::from_iso_string(timeStampStr));
    boost::posix_time::ptime now = boost::posix_time::second_clock::universal_time();
